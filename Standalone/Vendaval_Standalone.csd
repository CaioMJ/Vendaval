...
hslider bounds(804, 336, 149, 50) range(0, 1, 0.65, 1, 0.01) channel("ReverbMix")  text("Mix") trackercolour(188, 151, 49, 255) fontcolour(188, 151, 49, 255) textcolour(255, 255, 255, 255)
