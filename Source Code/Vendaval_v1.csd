...
form caption("Vendaval"), size(1000,500), colour(1, 1, 1), pluginid("cja1")
//Signature
...
rslider bounds(816, 389, 137, 93) range(0, 1, 0.2, 1, 0.01) channel("ReverbMix")  text("Reverb Mix") trackercolour(188, 151, 49, 255) textcolour(255, 255, 255, 255) fontcolour(188, 151, 49, 255) colour(255, 255, 255, 255)
//Wooing
...
//TO DO:
//Review randomized dynamic range
//Add presets
//Review manual
...
instr Wooing
    ...
    aNoiseBalanced balance aNoiseLp, aNoiseBp
...
instr Reverb
    ...
    aVerbL, aVerbR reverbsc aDryHp, aDryHp, .7, 4000, 44100, 10
